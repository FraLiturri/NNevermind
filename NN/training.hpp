...
void Hidden_Layer::BackPropagation(VectorXd d, double eta, double alpha, double lambda)
{
    //aggiustare d, ho modificato la classe in input da double a VectorXd
...
void Hidden_Layer::RandomTraining(VectorXd d, double eta, double alpha = 0, double lambda = 0)
{
    //aggiustare d, ho modificato la classe in input da double a VectorXd
