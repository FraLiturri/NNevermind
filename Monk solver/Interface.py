...
def submit_values():
    try:
        ...
        if(not eta_min_entry.get())&(not eta_max_entry.get())&(not lambda_min_entry.get())&(not lambda_max_entry.get())&(not alpha_min_entry.get())&(not alpha_max_entry.get()):
...
for widget in [eta_min_entry, eta_max_entry, lambda_min_entry, lambda_max_entry, alpha_min_entry, alpha_max_entry]:
